...
let i =0
  ...
  //  console.log((str.charAt(0)*10+str.charAt(1)*9+str.charAt(2)*8)MOD 5)

}
let checkId1 =  checkId('425');// 不合法
let checkId2 =  checkId('355');// 合法
let checkId3 =  checkId('754');// 不合法
let checkId4 =  checkId('100');// 合法
